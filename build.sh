...
docker build --tag=registry.okina.fr/na/bel:${PACKAGE_VERSION} --force-rm=true . --build-arg SSH_KEY="$(cat ~/.ssh/id_rsa)"
docker push registry.okina.fr/na/bel:${PACKAGE_VERSION}