...
docker build --tag=registry.okina.fr/mosaic/bel:${PACKAGE_VERSION} --force-rm=true . --build-arg SSH_KEY="$(cat ~/.ssh/id_rsa)"
docker push registry.okina.fr/mosaic/bel:${PACKAGE_VERSION}